# EcoEnergyCalc 인수인계 문서 v16 (2026-07-20 기준)

v15 문서 + 이번 세션(v15→v16) 내용 통합. 새 세션 시작 시 이 문서만 보고 이어서 작업 가능하도록 작성함.

## 0. v16 세션 핵심 요약 (2026-07-20) — 신규 AI 물 사용량 계산기 + 온수기 비교 페이지 보강
...
## 3. 현재 파일 개수 (2026-07-20 기준, 새 세션에서 재확인 필수)
- tools: 36개 (v16에서 ai-water-footprint-calculator 신규 추가)
- blog: 27개
- compare: 42개
