# EcoEnergyCalc 인수인계 문서 v18 (2026-07-27 기준)

v17 문서 + 이번 세션(v17→v18) 내용 통합. 새 세션 시작 시 이 문서만 보고 이어서 작업 가능하도록 작성함.

## 0. v18 세션 핵심 요약 (2026-07-27) — EV 클러스터 보강 3건 + AI 계산기 이미지생성 모드 추가, 신규 페이지 후보는 전부 레드오션으로 확인되어 보류
