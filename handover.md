# EcoEnergyCalc 인수인계 문서 v17 (2026-07-24 기준)

v16 문서 + 이번 세션(v16→v17) 내용 통합. 새 세션 시작 시 이 문서만 보고 이어서 작업 가능하도록 작성함.

## 0. v17 세션 핵심 요약 (2026-07-24) — 폭넓은 키워드 조사 + Demand Response 블로그 신규 + Portable AC 보강
...
## 3. 현재 파일 개수 (2026-07-24 기준, 새 세션에서 재확인 필수)
- tools: 37개 (v17에서 demand-response-savings-estimator 신규 추가)
- blog: 28개 (v17에서 demand-response-programs-get-paid-to-save-energy 신규 추가)
- compare: 43개 (v17에서 demand-response-vs-time-of-use-vs-solar-battery 신규 추가)
- glossary: 1개 파일에 용어 17개 (v17에서 Demand Response, BYOT 추가)
